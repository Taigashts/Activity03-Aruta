...
import calculator_script_1_stat as tothp
import calculator_script_1_stat as totatk
import calculator_script_1_stat as totdef
import calculator_script_1_stat as totatk
import calculator_script_1_stat as totaldef
import calculator_script_1_stat as totspd
import calculator_script_2_ev as evtk
...
match choose:
    ...
    case 1:
        ...
        if statch == "1":
            ...
            print("SP. ATK =", totatk.PokemonSTAT.totsatkReturnWithParams(level,basesatk,iv_satk,ev_satk,nature), end='\n\n')
            print("SP. DEF =", totaldef.PokemonSTAT.totsdefReturnWithParams(level,basesdef,iv_sdef,ev_sdef,nature), end='\n\n')
    ...
    case 2:
        ...
        print("\nATK =", evtk.PokemonEV.evatkReturnWithParams(base,stat,level,nature,iv,ev), end='\n\n')
